...
export const Definitions = {
  ...
  response_save_file: keybind(
    "ctrl+alt+s",
    "Save binary response file (Body tab)",
    false,
    "Request",
    ["main"],
  ),
  response_open_file: keybind(
    "ctrl+alt+o",
  ...
  cookie_delete: keybind("ctrl+w", "Delete domain", false, "Cookies", [
    "cookie-jar",
  ]),
  cookie_delete_domain: keybind("ctrl+d", "Delete cookie", false, "Cookies", [
    "cookie-jar",
  ]),
  cookie_clear: keybind("ctrl+alt+w", "Clear cookie jar", false, "Cookies", [
    "cookie-jar",
  ]),
...
export const CommandMap = {
  ...
  response_save_file: "response.save-file",
  response_open_file: "response.open-file",
