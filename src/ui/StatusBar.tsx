...
export function statusBarText(input: {
  ...
  // ── RIGHT: global hints ────────────────────────────
  const right = `[${displayKey(kb.request_send)}] send · [${displayKey(kb.request_save)}] save · [${displayKey(kb.request_new)}] new request · [${displayKey(kb.layout_toggle)}] layout · [${kb.focus_next}] focus · [${kb.help_toggle}] help · [^c] quit`
