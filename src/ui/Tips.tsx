...
const TIPS = [
  ...
  "reuse JavaScript with {scripts.pre: ./scripts/prepare.js}; paths start at the collection root",
  "add {tests} with {test} and {expect}, inline or in a {./file.js}; inspect response {Results}",
  ...
  "type {$random.} or {$time.} while editing a body or text form value to explore generated values",
  ...
  "open {^P}, choose Show Last Notification to read and scroll the latest message",
