# Generated by Django 5.2.9 on 2025-12-21 19:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('CHECKING', 'Checking'), ('SAVINGS', 'Savings / Investment'), ('CASH', 'Cash / Wallet'), ('CREDIT', 'Credit Card'), ('LOAN', 'Loan / Line of Credit')], max_length=20)),
                ('currency', djmoney.models.fields.CurrencyField(default='USD', max_length=3)),
                ('closing_day', models.PositiveIntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('installment_plan', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='transactions', to='finance.installmentplan')),
                ('tags', models.ManyToManyField(blank=True, related_name='transactions', to='finance.tag')),
                ('transfer_partner', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='transfer_original', to='finance.transaction')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='category',
            index=models.Index(fields=['user'], name='finance_cat_user_id_8bdef8_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='category',
            unique_together={('user', 'name')},
        ...
        migrations.AddIndex(
            model_name='tag',
            index=models.Index(fields=['user'], name='finance_tag_user_id_f35ce2_idx'),
        ),
        migrations.AlterUniqueTogether(
            name='tag',
            unique_together={('user', 'name')},
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['account', 'payment_date'], name='finance_tra_account_0bd56f_idx'),
        ),
        migrations.AddIndex(
            model_name='transaction',
            index=models.Index(fields=['payment_date'], name='finance_tra_payment_1290b1_idx'),
        ),
        migrations.AddIndex(
            model_name='transaction',
        ...
        migrations.AddIndex(
            model_name='transaction',
            index=models.Index(fields=['installment_plan'], name='finance_tra_install_424ca3_idx'),
        ),
    ]
