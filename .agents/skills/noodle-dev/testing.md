...
| Response expressions and assertions  | `tests/unit/responseExpression.test.ts`, `tests/unit/assertions.test.ts`, `tests/lang.test.ts`, `tests/integration/automation.test.ts` |
