...
```text terminal=text-align-lines
left        center      right
...
`textAlign` does not replace [Yoga box alignment](/docs/core-concepts/layout#alignment).
...
| `wrapMode`                       | `"none" \| "char" \| "word"`      | `"word"`     | Line wrapping mode                       |
