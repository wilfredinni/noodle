...
As an independent illustration, a bordered list of 12 source files initially shows its first five rows:
...
The independent file-list illustration after `scrollTo(5)`:
