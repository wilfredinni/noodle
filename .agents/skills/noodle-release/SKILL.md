...
4. Update only the affected README, `AGENTS.md`, skills, and site pages. Preserve each repository's existing voice and examples.
5. Add a concise release-note candidate for user-visible fixes. A bug fix does not require a guide update unless it changes a documented interaction.
